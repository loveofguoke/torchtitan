...
"""TileLang forward kernel for top-k absorbed SparseMLA.

Q and compressed KV contain a 512-dimensional latent part and a
64-dimensional RoPE tail. Both contribute to attention scores, while values
and outputs use only the latent part. The kernel loads only indexed KV rows,
uses online softmax, and stores base-2 LSE for backward.
"""
